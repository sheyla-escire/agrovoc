...
<xsl:stylesheet
    ...
    <xsl:template match="dri:pageMeta">
        <pageMeta>
            ...
            <xsl:if test="/dri:document/dri:body/dri:div[@n='lookup' or @rend='rest-container']">
                <metadata element="framing" qualifier="modal">true</metadata>
            </xsl:if>
    ...
    <!-- <xsl:template match="dri:meta/dri:pageMeta/dri:metadata[@element='javascript'][@qualifier='static'][text()='static/js/rest-support.js']"/> -->
