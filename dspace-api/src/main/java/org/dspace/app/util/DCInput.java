...
public class DCInput
{
    ...
    private boolean closedVocabulary = false;
      ...
      /** the name of the controlled rest to use */
    private String rest = null;

    /** is the entry closed to rest terms? */
    private boolean closedRest = false;
    ...
    public DCInput(Map<String, String> fieldMap, Map<String, List<String>> listMap)
    {
        ...
        rest = fieldMap.get("rest");
        String closedVocabularyStr = fieldMap.get("closedVocabulary");
        closedVocabulary = "true".equalsIgnoreCase(closedVocabularyStr)
                            || "yes".equalsIgnoreCase(closedVocabularyStr);
        String closedRestStr = fieldMap.get("closedRest");
        closedRest = "true".equalsIgnoreCase(closedRestStr)
                            || "yes".equalsIgnoreCase(closedRestStr);
